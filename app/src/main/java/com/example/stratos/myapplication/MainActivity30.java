...
import com.example.stratos.myapplication.databinding.ActivityMain30Binding;
...
public class MainActivity30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityMain30Binding binding = DataBindingUtil.setContentView(this, R.layout.activity_main30);
