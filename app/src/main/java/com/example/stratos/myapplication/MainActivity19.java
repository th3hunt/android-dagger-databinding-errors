...
import com.example.stratos.myapplication.databinding.ActivityMain19Binding;
...
public class MainActivity19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityMain19Binding binding = DataBindingUtil.setContentView(this, R.layout.activity_main19);
