...
import com.example.stratos.myapplication.databinding.ActivityMain28Binding;
...
public class MainActivity28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityMain28Binding binding = DataBindingUtil.setContentView(this, R.layout.activity_main28);
